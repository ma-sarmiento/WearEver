...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _pickAndUploadPhoto() async {
    try {
      ...
      if (url != null) {
        await FirestoreService().updateUserField('foto_perfil', url);
  ...
  void _openFollowList(String mode) {
    Navigator.pushNamed(
      context,
      '/followers',
      arguments: {'mode': mode, 'uid': FirebaseAuth.instance.currentUser?.uid ?? ''},
    );
  }
  ...
  Widget _buildMenuList() {
    final items = [
      ...
      {'icon': Icons.settings_outlined, 'label': 'Configuración', 'route': '/settings', 'danger': false},
